...
Shader "Polyart/Dreamscape/Builtin/Rock Detail"
{
	...
	SubShader
	{
		...
		inline float4 TriplanarSampling35_g302( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
			float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
			projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
			float3 nsign = sign( worldNormal );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_1_0_g305 = _SlopeContrast;
			float3 ase_vertexNormal = mul( unity_WorldToObject, float4( ase_worldNormal, 0 ) );
			ase_vertexNormal = normalize( ase_vertexNormal );
			float3 objToWorldDir51_g302 = mul( unity_ObjectToWorld, float4( ase_vertexNormal, 0 ) ).xyz;
			float dotResult18_g302 = dot( objToWorldDir51_g302 , float3(0,2,0) );
			float temp_output_21_0_g302 = ( ( _SlopeOffset + dotResult18_g302 ) * 2.0 );
			float clampResult22_g302 = clamp( temp_output_21_0_g302 , 0.0 , 1.0 );
			float lerpResult7_g305 = lerp( ( 0.0 - temp_output_1_0_g305 ) , ( temp_output_1_0_g305 + 0.0 ) , clampResult22_g302);
			float clampResult8_g305 = clamp( lerpResult7_g305 , 0.0 , 1.0 );
			float temp_output_1_0_g303 = _SlopeContrast;
			float3x3 ase_tangentToWorldFast = float3x3(ase_worldTangent.x,ase_worldBitangent.x,ase_worldNormal.x,ase_worldTangent.y,ase_worldBitangent.y,ase_worldNormal.y,ase_worldTangent.z,ase_worldBitangent.z,ase_worldNormal.z);
			float3 tangentToWorldDir6_g302 = mul( ase_tangentToWorldFast, temp_output_32_7 );
			float dotResult7_g302 = dot( tangentToWorldDir6_g302 , float3(0,1,0) );
			float lerpResult11_g302 = lerp( 0.0 , 3.0 , ( dotResult7_g302 + _SlopeOffset ));
			float clampResult12_g302 = clamp( lerpResult11_g302 , 0.0 , 1.0 );
			float lerpResult7_g303 = lerp( ( 0.0 - temp_output_1_0_g303 ) , ( temp_output_1_0_g303 + 0.0 ) , clampResult12_g302);
			float clampResult8_g303 = clamp( lerpResult7_g303 , 0.0 , 1.0 );
			float temp_output_1_0_g307 = _SlopeContrast;
			float2 temp_cast_5 = (_NoiseTextureSize).xx;
			float4 triplanar35_g302 = TriplanarSampling35_g302( _SlopeNoiseTexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_5, 1.0, 0 );
			float clampResult42_g302 = clamp( (triplanar35_g302).x , 0.0 , 1.0 );
			float lerpResult7_g307 = lerp( ( 0.0 - temp_output_1_0_g307 ) , ( temp_output_1_0_g307 + 0.0 ) , ( temp_output_21_0_g302 + clampResult42_g302 ));
			float clampResult8_g307 = clamp( lerpResult7_g307 , 0.0 , 1.0 );
			float clampResult26_g302 = clamp( clampResult8_g307 , 0.0 , 1.0 );
			#if defined(_EDGEBLENDING_VERTEXBLENDING)
				float staticSwitch43_g302 = clampResult8_g305;
			#elif defined(_EDGEBLENDING_NORMALBLENDING)
				float staticSwitch43_g302 = clampResult8_g303;
			#elif defined(_EDGEBLENDING_NOISEBLENDING)
				float staticSwitch43_g302 = clampResult26_g302;
			#else
				float staticSwitch43_g302 = clampResult8_g305;
			#endif
			float temp_output_149_0 = staticSwitch43_g302;
			float3 lerpResult56 = lerp( staticSwitch81 , UnpackScaleNormal( tex2D( _CoverageNormalMap, temp_output_19_0_g286 ), _CoverageNormalIntensity ) , temp_output_149_0);
			...
			float4 lerpResult55 = lerp( staticSwitch77 , ( color13_g286 * tex2D( _CoverageColorMap, temp_output_19_0_g286 ) ) , temp_output_149_0);
			#ifdef _ENABLECOVERAGE_ON
			...
			float lerpResult63 = lerp( ( tex2DNode9_g287.b * _CoverageMetallicIntensity ) , temp_output_32_3 , temp_output_149_0);
			#ifdef _ENABLECOVERAGE_ON
			...
			float lerpResult62 = lerp( temp_output_32_5 , ( 1.0 - ( tex2DNode9_g287.g * _CoverageRoughnessIntensity ) ) , temp_output_149_0);
			#ifdef _ENABLECOVERAGE_ON
			...
			float lerpResult64 = lerp( lerpResult10_g287 , temp_output_32_8 , temp_output_149_0);
			#ifdef _ENABLECOVERAGE_ON
...
Node;AmplifyShaderEditor.FunctionNode;149;-358.0807,1073.428;Inherit;False;PA_SF_VerticalBlend;34;;302;b9497802ac41dee4999b8364feedf4c9;0;3;36;SAMPLER2D;;False;38;FLOAT;1;False;2;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2077.191,68.90057;Float;False;True;-1;2;;0;0;Standard;Polyart/Dreamscape/Builtin/Rock Detail;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=B749605B3719A927ECCBD6CCE3553872D4636013